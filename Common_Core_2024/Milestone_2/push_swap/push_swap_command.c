...
/*   Updated: 2025/03/25 16:34:27 by igilani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void	rotate_both(t_push_swap_stack **a, t_push_swap_stack **b, t_push_swap_stack *cheapest_node)
{
...
static void	reverse_rotate_both(t_push_swap_stack **a, t_push_swap_stack **b, t_push_swap_stack *cheapest_node)
{
	while (*a != cheapest_node->target_node
		&& *b != cheapest_node)
		rrr(a, b, false);
