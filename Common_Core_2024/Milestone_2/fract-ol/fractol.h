...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/03 15:08:55 by igilani           #+#    #+#             */
/*   Updated: 2025/03/03 15:08:56 by igilani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define GREY 0x00AFAFAF
# define RED 0xFF0000
# define ELETRIC_BLUE 0x0066FF

# define M "Usage: ./fractol mandelbrot, julia 'value 1' 'value 2' or tricorn\n"
...
typedef struct s_data
{
	...
	int		line_length;
	int		endian;
	double	hypotenuse;	// Teorema di pit. per controllare se e' in Mandelbrot
