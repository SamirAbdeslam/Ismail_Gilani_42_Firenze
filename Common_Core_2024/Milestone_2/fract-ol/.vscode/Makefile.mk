...
#    Updated: 2025/02/07 19:00:22 by igilani          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Regole principali
all: $(NAME)
	$(call PROGRESS_BAR_END,\033[32m,Libreria \033[33mMiniLibX\033[0m \033[32mgenerata)
	$(call PROGRESS_BAR_END,\033[32m,Eseguibile \033[33m$(NAME)\033[0m \033[32mgenerato)
...
$(NAME): $(OBJ) $(LIB)
	@$(CC) $(CFLAGS) $^ -o $@ minilibx-linux/libmlx_Linux.a -lm -lX11 -lXext
